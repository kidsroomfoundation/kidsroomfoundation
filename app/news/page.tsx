      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {featuredArticle && (
          <Link href={`/news/${featuredArticle.slug}`} className="block group">
            <div className="mb-12 bg-white rounded-3xl shadow-xl shadow-earth-100/50 border border-coral-100/50 overflow-hidden transition-transform group-hover:-translate-y-1">
              ...
              <div className="p-8 md:p-12 max-w-4xl mx-auto">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-earth-800 mb-4 leading-tight group-hover:text-coral-600 transition-colors">
                ...
                <span className="inline-flex items-center gap-2 text-coral-600 font-semibold group-hover:text-coral-500">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {regularArticles.map((article) => (
              <Link key={article.slug} href={`/news/${article.slug}`} className="block h-full">
                <article className="bg-white rounded-3xl shadow-lg shadow-earth-100/50 border border-coral-100/50 overflow-hidden hover:shadow-xl transition-all hover:-translate-y-1 h-full flex flex-col group">
                  <div className="relative h-48 w-full bg-earth-100 shrink-0">
                    <Image
                      src={article.image}
                      alt={article.title}
                      fill
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    ...
                    <h3 className="text-xl font-bold text-earth-800 mb-3 line-clamp-2 group-hover:text-coral-600 transition-colors">
                      {article.title}
                    </h3>
                    <p className="text-earth-600 text-sm mb-6 leading-relaxed line-clamp-3 flex-grow">
                      {article.excerpt}
                    </p>
                    <div className="flex items-center justify-between pt-4 border-t border-earth-100 mt-auto">
